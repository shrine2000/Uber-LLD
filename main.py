#!/usr/bin/env python3
"""
Ridesharing Service Demo
Demonstrates the complete ridesharing system with drivers, riders, and trips.
"""
...
def main():
    print("=" * 60)
    print("RIDESHARING SERVICE DEMO")
    print("=" * 60)
    print()

    # Initialize TripManager (Singleton)
    trip_manager = TripManager()
    
    # Create locations
    location1 = Location(37.7749, -122.4194)  # San Francisco
    location2 = Location(37.7849, -122.4094)  # Nearby location
    location3 = Location(37.7949, -122.3994)  # Another location
    location4 = Location(37.8049, -122.3894)  # Far location
    ...
    print(f"   ✓ Registered {len(trip_manager.drivers)} drivers")
    print()
    ...
    # Scenario 1: Request a SEDAN trip
    print("-" * 60)
    ...
    # Scenario 2: Request an SUV trip
    print("-" * 60)
    ...
    # Scenario 3: Request an AUTO trip
    print("-" * 60)
    ...
    # Scenario 4: Change pricing strategy to Flat Rate
    print("-" * 60)
